  ...
  return (
    <>
      <div className='container-fluid home-s9-container'>
        ...
        {/* Row 1 */}
        <h2 className='home-s9-heading'
        data-aos="fade-down"
        data-aos-duration="800"
        data-aos-once="true">Powered by <span className='home-s9-highlight'>advanced IOT</span></h2>
        ...
        <div className='row home-s9-row2-container'>
            ...
            <div className='d-none d-md-block col-lg-6'>
                ...
                data-aos-once="true"
                >
                    <img className='home-s9-image' src={HomeS9Mobile} alt='Aeronero-Mobile.png' />
                </div>
            </div>
