...
// CSS
import './HomeCSS/HomeCompo14.css'
            ...
            <div className='home-s14-container-inside'>
                ...
                <div className='home-s14-txt-container-outside'>
                    <div className='home-s14-txt-container'>
                        <h5 className='home-s14-heading'
                        data-aos="fade-down"
                        data-aos-duration="800"
                        data-aos-once="true">World On Verge <span className='home-s14-highlight'>Of Water Scarcity</span></h5>
