...
import './HomeCSS/HomeSwipper.css'
        ...
        <div className="HomeComp5_Holder">
          <div className="HomeComp5_Section1">
            <h2 data-aos="fade-up" className="Heading">
              Explore <span className="highlightSpan">Our Products</span>
            </h2>
          </div>
              ...
              >
                <SwiperSlide>
                  <div className="CarouselImageCont">
                    <img
                      ...
                      alt="NeroImage"
                    />
                    <NavLink className="ExploreLink" to="/nero">
                ...
                <SwiperSlide>
                  <div className="CarouselImageCont">
                    ...
                    <NavLink className="ExploreLink" to="/bubble">
                      <button className="exploreButton">Explore</button>
                    </NavLink>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="CarouselImageCont">
                    <img
                      ...
                      alt="Drizzle"
                    />
                    <NavLink className="ExploreLink" to="/drizzle">
                      <button className="exploreButton">Explore</button>
                    </NavLink>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="CarouselImageCont">
                    <img
                      ...
                      alt="Thunder"
                    />
                    <NavLink className="ExploreLink" to="/thunder">
                      <button className="exploreButton">Explore</button>
                    </NavLink>
                  </div>
                </SwiperSlide>
                ...
                <SwiperSlide>
                  <div className="CarouselImageCont">
                    <img
                      ...
                      alt="Airwell"
                    />
                    <NavLink className="ExploreLink" to="/airwell">
                      <button className="exploreButton">Explore</button>
                    </NavLink>
                  </div>
                </SwiperSlide>
